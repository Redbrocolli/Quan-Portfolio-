...
export const projectsData = [
 {
    ...
    info: 'Using PIC16F877A microcontroller, I desinged an auto watering system. The system main aim is to provide the amount of irrigation to agricutural field by observing the moisture content of soil. ',
    info2: 'The system is also built in with an LCD, which is interfaced with the microcontroller for displaying the moisture content of soil and pump status. ',
    url:'',
